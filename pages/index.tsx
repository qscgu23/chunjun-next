...
const Home: NextPage = () => {
  ...
  return (
    <>
      <section
        className={`relative flex flex-col justify-center items-center section-padding md:h-[calc(100vh-64px)] h-[60vh] ${
      ...
      >
        ...
        <Text
          ...
          data-aos-delay="350"
          component="p"
          className="capitalize md:text-xl md:w-1/2 leading-relaxed text-base md:mb-12 mb-8 font-roboto"
        >
      ...
      <section
        className={`flex md:flex-row flex-col-reverse md:h-96 h-auto py-8 ${
      ...
      >
        ...
        >
          <Card
            ...
            radius="md"
            withBorder
            className="md:absolute relative md:w-64 md:left-6 md:top-8 z-0 hover:z-20 hover:scale-110 transition-all duration-200 ease-in-out"
          >
          ...
          <Card
            ...
            radius="md"
            withBorder
            className="md:absolute md:w-64 relative md:left-1/3 z-10 hover:z-20 hover:scale-110 transition-all duration-200 ease-in-out"
          >
            <Card.Section className="text-center p-4">
              <Image
          ...
          <Card
            ...
            radius="md"
            withBorder
            className="md:absolute relative md:w-64 md:right-2 md:top-12 z-0 hover:z-20 hover:scale-110 transition-all duration-200 ease-in-out"
          >
            <Card.Section className="text-center p-4">
              <Image
      ...
      >
        ...
        <div className="flex md:flex-row flex-col justify-center">
          <Card shadow="none" radius="md" className="md:mr-24 md:w-64 w-full">
            <Card.Section className="text-center p-4">
              <Image
                height={120}
                width={120}
