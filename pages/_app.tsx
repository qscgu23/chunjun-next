  ...
  return (
    <ColorSchemeProvider colorScheme={colorScheme} toggleColorScheme={toggleColorScheme}>
      <MantineProvider theme={{ colorScheme }} withGlobalStyles withNormalizeCSS>
        ...
        <AppShell
          padding={"md"}
          header={<AppHeader opened={opened} changeOpened={toggleNavbar} changeTheme={toggleColorScheme} theme={colorScheme} />}
          styles={(theme) => ({
            main: { backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[8] : theme.colors.white, padding: 0 },
          })}
          footer={<AppFooter />}
        >
          <Component {...pageProps} />
