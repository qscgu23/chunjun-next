    ...
    <div className="grid md:grid-cols-3 grid-cols-1 md:gap-6 gap-3">
      <section className='border p-10'>
        <Card data-aos="fade-up" shadow="none" p="md" data-aos-delay="0">
          <Card.Section className='flex justify-center'>
            <img src={require('../../assets/svg/apacheflink.svg').default.src} alt="flink" height={100} className='object-contain' />
          </Card.Section>
      ...
      <section className='border p-10'>
        <Card data-aos="fade-up" shadow="none" p="md" data-aos-delay="150">
          <Card.Section className='flex justify-center'>
            <img src={require('../../assets/svg/docker.svg').default.src} alt="flink" height={100} className='object-contain' />
          </Card.Section>
      ...
      <section className='border p-10'>
        <Card data-aos="fade-up" shadow="none" p="md" data-aos-delay="300">
          <Card.Section className='flex justify-center'>
            <img src={require('../../assets/svg/flex.svg').default.src} alt="flink" height={100} className='object-contain' />
          </Card.Section>
